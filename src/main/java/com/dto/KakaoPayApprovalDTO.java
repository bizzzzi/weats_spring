...
@Setter
@ToString
@Alias("KakaoPayApprovalDTO")
//최종적으로 결제 승인 시 응답받을 객체
public class KakaoPayApprovalDTO {
    private String aid; //요청 고유번호
    private String tid; // 결제 고유번호
    private String cid; // 가맹점 코드
    private String sid; // 정기결제용 ID, 정기 결제 CID로 단건 결제 요청시 발급
    ...
    private CardInfo card_info; //결제 상세정보, 결제수단이 카드 일 경우만 포함(Json) CardInfo객체 생성
