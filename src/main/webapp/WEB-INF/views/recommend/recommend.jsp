...
<!-- 스크롤 페이지 -->
  ...
  <section class="scroll-content">
    <div class="scroll-image">
      ...
      <div class="image-item"><img class="scene-img" src="images/recommend_3.jpg" alt=""></div>
      <div class="image-item"><img class="scene-img" src="images/recommend_4.jpg" alt=""></div>
      <div class="image-item"><img class="scene-img" src="images/recommend_5.jpg" alt=""></div>
      <div class="image-item"><img class="scene-img" src="images/recommend_6.jpg" alt=""></div>
    </div>
    <div class="scroll-text global-width">
      <div class="step">
        <p>평상시 레포츠에 관심이 많았던 팀원들이 레포츠 예약 사이트를 이용하며 불편했던 점을 보완하여<br/> 레포츠가 날씨에 영향을 많이 받는다는 것을 고려해 기상정보와 날씨 api를 이용하여 5일간의 기상 정보를 볼 수 있는 기능을 넣었고<br/> 실시간으로 날씨를 확인하는 동시에 레포츠를 예약할 수 있는 강점을 가진 사이트입니다.</p>
      </div>
      <div class="step">
      ...
      <div class="step">
        <p>중고거래<br/>파트너 뿐만 아니라 일반 회원에게도 판매가 가능하도록 했다.<br/>1회성 장비, 다른 레포츠 프로그램을 즐길 수 있는 선택의 폭을 넓힐 수 있도록<br/>레포츠 장비 판매를 위한 중고거래 게시판 마련하여<br/> 레포츠 예약을 위한 1회성 사이트 접속이 아닌 지속적인 유입 유도 </p>
      </div>
      <div class="step">
        <p>고생하셨습니다:)</p>
      </div>
